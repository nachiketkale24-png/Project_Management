...
const registerDonor = asynchandler(async (req, res) => {
  ...
  return res
    .status(201)
    .json(new ApiResponse(201, donor, "Donor registered successfully"));
});
...
const getAllDonors = asynchandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, donors, "Donors retrieved successfully"));
});
...
const getDonorById = asynchandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, donor, "Donor retrieved successfully"));
});
...
const updateDonor = asynchandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, donor, "Donor updated successfully"));
});
...
const getAllInventory = asynchandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, inventory, "Inventory retrieved successfully"));
});
...
const checkBloodAvailability = asynchandler(async (req, res) => {
  ...
  const totalUnits =
    availableBlood.length > 0 ? availableBlood[0].totalUnits : 0;
  ...
  return res
    ...
    .json(
      new ApiResponse(
        200,
        { bloodType, totalUnits },
        "Blood availability checked successfully",
      ),
    );
});
